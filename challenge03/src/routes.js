...
router.put('/orders/:id/delivery/', upload.single('file'), DeliveryOrderController.update);
...
router.delete('/problems/:id/cancel-delivery', DeliveryProblemController.destroy);
